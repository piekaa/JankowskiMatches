...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        char secondNumber = equation.charAt(1);
        char thirdNumber = equation.charAt(2);
        drawNumber(img, firstNumber, 0);
        drawNumber(img, secondNumber, 100);
        drawNumber(img, thirdNumber, 200);
...
//        if (number == '-'){
//            drawLine(img, false, false, false, false, false, false, false, true, false, false);
//        }
//        if (number == '+'){
//            drawLine(img, false, false, false, false, false, false, false, false, true, false);
//        }
//        if (number == '='){
//            drawLine(img, false, false, false, false, false, false, false, false, false, true);
//        }
    }
